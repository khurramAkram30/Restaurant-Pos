...
<body>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="m-0 mt-2">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input type="phone" class="form-control" id="inputpostCode">  id="inputpostCode"-->
                                                <input type="text" class="form-control" id="inputpostCode" name="sellist1">
                                            </div>
                                        </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="" class="form-control" readonly id="addresslogin" cols="30"
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <!-- <label for="inputEmail3" class="col-md-3 col-form-label">Address:</label> -->
                                        <div class="col-md-9">
                                            <button class="btn" onclick="updateAddress()">
                                                Update Address
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-3" id="cashbtn">
                        <div class="col-md-12">
                            <button class="btn form-control" onclick="saveData()"
                                style="background:#d0a772;" id="paysave">Pay</button>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-1">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="loginZipCode" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row mb-1">
                        <label for="inputEmail3" class="col-md-3 col-form-label">Address:</label>
                        <div class="col-md-9">
                            <textarea name="" class="form-control" id="loginAddress" cols="30" rows="5"></textarea>
                        </div>
                    </div>
    ...
    <script src="js/shppingCartValidation.js"></script>
...
<script>
    ...
    $("#inputpostCode").on("change", function () {
        ...
        var pattern = /^(KA1|KA2|KA3|KA4|KA5)/;

        if (pattern.test(zipcode)) {
            $("#paysave").prop("disabled", false);
            $("#inputpostCode").css("border","1px solid #00000038");
         
         
        } else {
            // Invalid input
            alert("We Are Deliver only in these zipcodes: KA1,KA2,KA3,KA4,KA5");
            $("#inputpostCode").css("border","1px solid red");
...
<script>
    ...
    function saveData() {
        if ($('input[name="paymentMethod"]:checked').length === 0) {
            ...
            alert("Please select either Cash or Card");
            // You can also use a more sophisticated popup/modal here
            // Example using Materialize CSS modal
            // $('.modal').modal('open');
        }
        else {
            var postdata;
            ...
            if (collapseId == "collapseOne") {
                var fnames=$("#inputName").val();
                var lastnames=$("#inputLastName").val();
                var emails=$("#inputEmail").val();
                var tele=$("#inputphone").val();
                var postcodes=$("#inputpostCode").val();
                var streetnames=$("#inputStreet").val();
                var address1=$("#inputAdress1").val();
                if(fnames == "" && lastnames == "" && emails == "" && tele == "" && postcodes == "" && address1 ==""){
    ...
    function updateAddress() {
        ...
        $("#loginAddress").val(userinformation.address1);
        $("#loginZipCode").val(userinformation.postcode)
        // $("#zipcodelogin").val(userinformation.postcode);
        // $("#addresslogin").val(userinformation.address1);
    }
    function updateAdd() {
        var address = $("#loginAddress").val();
        var zipcode = $("#loginZipCode").val();
        console.log(address);
        console.log(zipcode);
        ...
        $.ajax({
            url: `${localurl}users/updateAddress.php`,
            type: "POST",
            data: JSON.stringify(postdata),
            contentType: "application/json",
            success: function (response, status) {
                console.log(response);
                userinformation.postcode = zipcode;
                userinformation.address1 = address;
