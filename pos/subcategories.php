                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="subcategory" placeholder="Enter Sub category">
                                        </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <button onclick="" id="uploadButton" class="btn btn-primary">Add Category </button>
                                                <button type="button" id="loaderbtn" class="btn btn-primary btn-loading btn-icon" style="display:none"><i class="fe fe-check"></i></button>
                                            </div>
                                        </div>
...
$.ajax({
    url:`${baseurl}subcategories/create.php`,
    type:"POST",
...
categoryresult.forEach(item =>{
    var cretaelem=document.createElement("option");
    cretaelem.value=item.id;
    cretaelem.textContent=item.name;
    if (item.name === result.category_name) {
        // Set the 'selected' attribute if the condition is met
        cretaelem.setAttribute("selected", "selected");
    }    
    $("#editcatrgory").append(cretaelem);
...
function edit(){
var idofdata=$("#idd").val();
var category=$("#editcatrgory").val();
...
console.log(postdata);
$.ajax({
    url:`${baseurl}subcategories/update.php?id=${idofdata}`,
    type:"PUT",
    data:JSON.stringify(postdata),
    contentType:"application/json",
    success:function(status){
