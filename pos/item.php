                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <button onclick="" id="uploadButton" class="btn btn-primary">Add Item </button>
...
$("#catrgory").on("change",function(){
    ...
    $.ajax({
    url:`${baseurl}subcategories/read.php?id=${catid}`,
    type:"GET",
    contentType:"application/json",
    success:function(response,status){
        var data=response.response;
...
const forms = document.getElementById("addItemForm");
const formData = new FormData(forms);

var catid = document.getElementById("catrgory").value;
