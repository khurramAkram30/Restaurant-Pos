...
">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="dashboard.php"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="categories.php"><i class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Categories</span></a>
                            </li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Items</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="viewOrder.php" class="slide-item">View order</a></li>
                            ...
                            <li>
                                <a class="side-menu__item has-link" href="landing-page.html"><i
                                        ...
                                        class="side-menu__label">Landing Page</span></a>
                            </li> -->
