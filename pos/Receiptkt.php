  ...
  <div id="invoice-POS">
    ...
    <div id="mid">
      <div class="info">
        ...
        <?php
                $myID = $_GET['id'];
                $query = "select * from `orders` where orderID = '$myID'";
        ...
        <p>
            Kitchen Copy <br>
        <?php $server_namedepnd =  $row['ordertype'] == 'DineIn' ? $row['server'] : ' Anonymous';
        echo "Server # " .  $server_namedepnd; ?><br>
        <?php echo "Invoice # " . $row['orderID']; ?><br>
        <?php 
